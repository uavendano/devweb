...
export default function Calendario() {
    ...
    const fetchFechas = async () => {
        try {
            const response = await axios.get(API_ROUTES.COURSE_SCHEDULE)/1;
    ...
    useEffect(() => {          
        ...
        fetchFechas(); // Llamamos a la API al montar el componente
            ...
            <div className="mt-5">
                <div className="container custom-color">
                    <div className="col-md-12 m-auto text-center">
                        ...
                        <img src={imgCalendario(`./curso-ai.png`)} className="img-fluid img-w-50 mt-5" width="200" alt="Ottolearn" />
                        {renderFechas()}
                    </div>
                </div>
            </div>
