import '../../css/components/bloqueIcoTxt.css';
import { Link } from 'react-router-dom';

const imgPath = require.context('../../images/componentes/BloqueIcoTxt',true);

export default function BloqueIcoTxt({ancla,subtitle,info,buttons,img,altText}) {
    return (
        <>            
